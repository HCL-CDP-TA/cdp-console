...
export default function DataSourcesPage() {
  ...
  const handleAuthExpired = () => {
    console.log("Auth expired on data sources page - clearing state and redirecting")
    clearAuthState()
    router.push("/login")
  }
  ...
  return (
    <AppLayout>
      <div className="p-6">
        {selectedTenant ? (
          <DataSourcesManager tenant={selectedTenant} onAuthExpired={handleAuthExpired} />
        ) : (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-600 mb-4">Please select a tenant to view data sources</p>
